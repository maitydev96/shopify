export const ErrorIconUrl = `data:image/svg+xml;base64,${btoa(`<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path
    fill-rule="evenodd"
    clip-rule="evenodd"
...
export const FixIconUrl = `data:image/svg+xml;base64,${btoa(`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path
...
`)}`;
export const CopyIconUrl = `data:image/svg+xml;base64,${btoa(`<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path
...
export const ChevronRightIconUrl = `data:image/svg+xml;base64,${btoa(`<svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;
export const Style = (overlayStyle)=>{
    const style = [];
...
export const checkIfInGadgetIFrame = ()=>{
...
export const overlayTemplate = (overlay)=>{
...
export function patchOverlay(code, environment) {
