// All the generated types for the "productCustomization" model preconditions, actions, params, etc
...
export interface CreateProductCustomizationActionContext extends AmbientContext {
  ...
  */
  params: {
productCustomization?: { product?: { _link: string | null };productVariantId?: number;customizationValue?: string;customizationType?: string;shop?: { _link: string | null }; };
};
  /**
