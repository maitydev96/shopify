// All the generated types for the "orderTracking" model preconditions, actions, params, etc
...
export interface CreateOrderTrackingActionContext extends AmbientContext {
  ...
  */
  params: {
orderTracking?: { shippingCarrier?: string;trackingNumber?: string;deliveryStatus?: string;order?: { _link: string | null };shop?: { _link: string | null }; };
};
  /**
