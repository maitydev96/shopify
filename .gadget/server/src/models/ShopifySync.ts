...
export interface AbortShopifySyncActionContext extends AmbientContext {
  ...
  */
  params: {
shopifySync?: { shop?: { _link: string | null };syncSince?: Date;domain?: string;errorDetails?: string;errorMessage?: string;syncSinceBy?: string;force?: boolean;models?: Scalars["JSON"]; };    
id?: string;
};
  /**
