...
export interface UpdateShopifyShopActionContext extends AmbientContext {
  ...
  */
  params: {
shopifyShop?: { id?: string;plan?: Scalars["JSON"];address1?: string;marketingSmsContentEnabledAtCheckout?: boolean;planPublicDisplayName?: string;planDisplayName?: string;transactionalSmsDisabled?: boolean;address2?: string;checkoutApiSupported?: boolean;city?: string;country?: string;countryCode?: string;countryName?: string;countyTaxes?: Scalars["JSON"];currency?: string;customerEmail?: string;domain?: string;eligibleForPayments?: boolean;email?: string;enabledPresentmentCurrencies?: string[];finances?: boolean;googleAppsDomain?: string;googleAppsLoginEnabled?: boolean;hasDiscounts?: boolean;hasGiftCards?: boolean;hasStorefront?: boolean;ianaTimezone?: string;latitude?: number;longitude?: number;moneyFormat?: string;moneyInEmailsFormat?: string;moneyWithCurrencyFormat?: string;moneyWithCurrencyInEmailsFormat?: string;multiLocationEnabled?: boolean;myshopifyDomain?: string;name?: string;passwordEnabled?: boolean;phone?: string;planName?: string;preLaunchEnabled?: boolean;primaryLocale?: string;shopifyCreatedAt?: Date;province?: string;provinceCode?: string;requiresExtraPaymentsAgreement?: boolean;setupRequired?: boolean;shopOwner?: string;source?: string;taxShipping?: boolean;taxesIncluded?: boolean;timezone?: string;shopifyUpdatedAt?: Date;weightUnit?: string;alerts?: Scalars["JSON"];billingAddress?: Scalars["JSON"];countriesInShippingZones?: Scalars["JSON"];currencyFormats?: Scalars["JSON"];customerAccounts?: string;zipCode?: string;description?: string;orderNumberFormatPrefix?: string;orderNumberFormatSuffix?: string;resourceLimits?: Scalars["JSON"];richTextEditorUrl?: string;shipsToCountries?: string[];timezoneAbbreviation?: string;timezoneOffset?: string;timezoneOffsetMinutes?: number;unitSystem?: string;customerAccountsV2?: Scalars["JSON"];url?: string; };    
id?: string;
};
  /**
