	...
	*/
	params: {
		shopifyOrder?: {
			...
			currentSubtotalPriceSet?: Scalars["JSON"]
			currentTotalDiscounts?: string
			currentTotalDiscountsSet?: Scalars["JSON"]
			currentTotalDutiesSet?: Scalars["JSON"]
			currentTotalPrice?: string
			currentTotalPriceSet?: Scalars["JSON"]
			currentTotalTax?: string
			currentTotalTaxSet?: Scalars["JSON"]
			...
			originalTotalDutiesSet?: Scalars["JSON"]
			...
			totalShippingPriceSet?: Scalars["JSON"]
			totalTax?: string
			totalTaxSet?: Scalars["JSON"]
			totalTipReceived?: string
			totalWeight?: number
			additionalFees?: Scalars["JSON"]
			currentTotalAdditionalFeesSet?: Scalars["JSON"]
			merchantOfRecordAppId?: number
			originalTotalAdditionalFeesSet?: Scalars["JSON"]
			sourceIdentifier?: string
			sourceUrl?: string
			taxExempt?: boolean
			fulfillmentsCount?: Scalars["JSON"]
			cancellation?: Scalars["JSON"]
			risk?: Scalars["JSON"]
			shopifyProtect?: Scalars["JSON"]
			totalCashRoundingAdjustment?: Scalars["JSON"]
			transactionsCount?: Scalars["JSON"]
			billingStatusMatchesShippingAddress?: boolean
			poNumber?: string
			alerts?: Scalars["JSON"]
			canMarkAsPaid?: boolean
			canNotifyCustomer?: boolean
			capturable?: boolean
			cartDiscountAmountSet?: Scalars["JSON"]
			closed?: boolean
			confirmationNumber?: string
			confirmed?: boolean
			currentCartDiscountAmountSet?: Scalars["JSON"]
			currentSubtotalLineItemsQuantity?: number
			currentTotalWeight?: string
			currentShippingPriceSet?: Scalars["JSON"]
			...
			merchantEditableErrors?: Scalars["JSON"]
			netPaymentSet?: Scalars["JSON"]
			originalTotalPriceSet?: Scalars["JSON"]
			refundDiscrepencySet?: Scalars["JSON"]
			refundable?: boolean
			requiresShipping?: boolean
			restockable?: boolean
			returnStatus?: string
			totalCapturableSet?: Scalars["JSON"]
			totalOutstandingSet?: Scalars["JSON"]
			totalReceivedSet?: Scalars["JSON"]
			totalRefundedSet?: Scalars["JSON"]
			totalRefundedShippingSet?: Scalars["JSON"]
			totalTipReceivedSet?: Scalars["JSON"]
			unpaid?: boolean
			customerJourneySummary?: Scalars["JSON"]
			shop?: {
				_link: string | null
			}
		}
