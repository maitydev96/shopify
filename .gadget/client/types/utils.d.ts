 ...
 **/
export declare const fieldSelectionToQueryCompilerFields: (selection: FieldSelection, includeTypename?: boolean) => BuilderFieldSelection;
export declare const variableOptionsToVariables: (variables: VariablesOptions) => Record<string, Variable>;
export {};
