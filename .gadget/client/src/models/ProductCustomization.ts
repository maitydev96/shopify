...
import {
  ...
  AvailableProductCustomizationSelection,
  ProductCustomizationSort,
  ProductCustomizationFilter,
  CreateProductCustomizationInput,
  UpdateProductCustomizationInput,
  Scalars,
  UpsertProductCustomizationInput
} from "../types.js";
...
*/
export type SelectedProductCustomizationOrDefault<Options extends Selectable<AvailableProductCustomizationSelection>> = DeepFilterNever<
    Select<
      ProductCustomization,
      DefaultSelection<
        AvailableProductCustomizationSelection,
        Options,
        typeof DefaultProductCustomizationSelection
      >
    >
  >;
 ...
 * ```
 */
export type ProductCustomizationRecord<Selection extends AvailableProductCustomizationSelection | undefined = typeof DefaultProductCustomizationSelection> = DeepFilterNever<
  GadgetRecord<
    SelectedProductCustomizationOrDefault<{
      select: Selection;
    }>
  >
>;

export const DefaultProductCustomizationSelection = {
     __typename: true,
     id: true,
     createdAt: true,
...
const modelApiIdentifier = "productCustomization" as const;
const pluralModelApiIdentifier = "productCustomizations" as const;
 ...
 **/
export type CreateProductCustomizationResult<Options extends CreateProductCustomizationOptions> = SelectedProductCustomizationOrDefault<Options> extends void ?
      void :
      GadgetRecord<SelectedProductCustomizationOrDefault<Options>>;
/**
 ...
 * Is a GadgetRecord of the model's type.
 **/
export type UpdateProductCustomizationResult<Options extends UpdateProductCustomizationOptions> = SelectedProductCustomizationOrDefault<Options> extends void ?
      void :
      GadgetRecord<SelectedProductCustomizationOrDefault<Options>>;
/**
 ...
 * This is the flattened style of inputs, suitable for general use, and should be preferred.
 **/
export type UpsertProductCustomizationVariables = Omit<
     UpsertProductCustomizationInput,
     "on"
   > & {
     on?: ((Scalars['String'] | null))[];
 ...
 *
 **/
export type UpsertProductCustomizationResult<Options extends UpsertProductCustomizationOptions> = SelectedProductCustomizationOrDefault<Options> extends void ?
      void :
      GadgetRecord<SelectedProductCustomizationOrDefault<Options>>;
...
export type ProductCustomizationManager = {
  ...
  create: {
      ...
      * * const productCustomizationRecord = await api.productCustomization.create({
        ...
        * });
      **/
      <Options extends CreateProductCustomizationOptions>(
      
        variables: CreateProductCustomizationVariables,
        options?: LimitToKnownKeys<Options, CreateProductCustomizationOptions>
      ): Promise<CreateProductCustomizationResult<Options>>;
      /**
       * Executes the create action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
      *
      ...
      **/
      <Options extends CreateProductCustomizationOptions>(
        ...
        variables: FullyQualifiedCreateProductCustomizationVariables,
        options?: LimitToKnownKeys<Options, CreateProductCustomizationOptions>
      ): Promise<CreateProductCustomizationResult<Options>>;
      type: 'action';
      ...
      variablesType: ((
               ...
               & (FullyQualifiedCreateProductCustomizationVariables | CreateProductCustomizationVariables)
             ) | undefined);
  ...
  bulkCreate: {
      /**
        ...
        */
       <Options extends CreateProductCustomizationOptions>(
          inputs: (FullyQualifiedCreateProductCustomizationVariables | CreateProductCustomizationVariables)[],
          options?: LimitToKnownKeys<Options, CreateProductCustomizationOptions>
       ): Promise<CreateProductCustomizationResult<Options>[]>
      type: 'action';
      ...
      namespace: null;
      variables: {
          inputs: { required: true, type: '[BulkCreateProductCustomizationsInput!]' }
        };
  ...
  update: {
      ...
      * * const productCustomizationRecord = await api.productCustomization.update("1", {
        ...
        * });
      **/
      <Options extends UpdateProductCustomizationOptions>(
        id: string,
        variables: UpdateProductCustomizationVariables,
        options?: LimitToKnownKeys<Options, UpdateProductCustomizationOptions>
      ): Promise<UpdateProductCustomizationResult<Options>>;
      /**
       * Executes the update actionon one record specified by `id`.Runs the action and returns a Promise for the updated record.
      *
      * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
      ...
      **/
      <Options extends UpdateProductCustomizationOptions>(
        id: string,
        variables: FullyQualifiedUpdateProductCustomizationVariables,
        options?: LimitToKnownKeys<Options, UpdateProductCustomizationOptions>
      ): Promise<UpdateProductCustomizationResult<Options>>;
      type: 'action';
  ...
  bulkUpdate: {
      /**
        ...
        */
       <Options extends UpdateProductCustomizationOptions>(
          inputs: (FullyQualifiedUpdateProductCustomizationVariables | UpdateProductCustomizationVariables & { id: string })[],
          options?: LimitToKnownKeys<Options, UpdateProductCustomizationOptions>
       ): Promise<UpdateProductCustomizationResult<Options>[]>
      type: 'action';
      ...
      namespace: null;
      variables: {
          inputs: { required: true, type: '[BulkUpdateProductCustomizationsInput!]' }
        };
      variablesType: (FullyQualifiedUpdateProductCustomizationVariables | UpdateProductCustomizationVariables & { id: string })[];
      paramOnlyVariables: [];
      selectionType: AvailableProductCustomizationSelection;
      schemaType: Query["productCustomization"];
      defaultSelection: typeof DefaultProductCustomizationSelection;
  ...
  delete: {
      ...
      **/
      <Options extends DeleteProductCustomizationOptions>(
        id: string,
      
        options?: LimitToKnownKeys<Options, DeleteProductCustomizationOptions>
      ): Promise<DeleteProductCustomizationResult<Options>>;
      type: 'action';
  ...
  upsert: {
      ...
      * * const result = await api.productCustomization.upsert({
        ...
        * });
      **/
      <Options extends UpsertProductCustomizationOptions>(
      
        variables: UpsertProductCustomizationVariables,
        options?: LimitToKnownKeys<Options, UpsertProductCustomizationOptions>
      ): Promise<UpsertProductCustomizationResult<Options>>;
      /**
       * Executes the upsert action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
      *
      * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
      ...
      **/
      <Options extends UpsertProductCustomizationOptions>(
        ...
        variables: FullyQualifiedUpsertProductCustomizationVariables,
        options?: LimitToKnownKeys<Options, UpsertProductCustomizationOptions>
      ): Promise<UpsertProductCustomizationResult<Options>>;
      type: 'action';
      ...
      variablesType: ((
               ...
               & (FullyQualifiedUpsertProductCustomizationVariables | UpsertProductCustomizationVariables)
             ) | undefined);
      hasAmbiguousIdentifier: false;
  ...
  bulkUpsert: {
      /**
        ...
        */
       <Options extends UpsertProductCustomizationOptions>(
          inputs: (FullyQualifiedUpsertProductCustomizationVariables | UpsertProductCustomizationVariables)[],
          options?: LimitToKnownKeys<Options, UpsertProductCustomizationOptions>
       ): Promise<any[]>
      type: 'action';
      ...
      namespace: null;
      variables: {
          inputs: { required: true, type: '[BulkUpsertProductCustomizationsInput!]' }
        };
...
/**
 * A manager for the productCustomization model with all the available operations for reading and writing to it.*/
export const ProductCustomizationManager = buildModelManager(
  modelApiIdentifier,
