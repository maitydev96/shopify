...
import { Query, IDsList, PromiseOrLiveIterator, OrderTracking, AvailableOrderTrackingSelection, OrderTrackingSort, OrderTrackingFilter, CreateOrderTrackingInput, UpdateOrderTrackingInput, Scalars, UpsertOrderTrackingInput } from "../types.js";
...
*/
export type SelectedOrderTrackingOrDefault<Options extends Selectable<AvailableOrderTrackingSelection>> = DeepFilterNever<Select<OrderTracking, DefaultSelection<AvailableOrderTrackingSelection, Options, typeof DefaultOrderTrackingSelection>>>;
/**
 ...
 * ```
 */
export type OrderTrackingRecord<Selection extends AvailableOrderTrackingSelection | undefined = typeof DefaultOrderTrackingSelection> = DeepFilterNever<GadgetRecord<SelectedOrderTrackingOrDefault<{
    select: Selection;
}>>>;
export declare const DefaultOrderTrackingSelection: {
...
declare const modelApiIdentifier: "orderTracking";
declare const pluralModelApiIdentifier: "orderTrackings";
 ...
 **/
export type CreateOrderTrackingResult<Options extends CreateOrderTrackingOptions> = SelectedOrderTrackingOrDefault<Options> extends void ? void : GadgetRecord<SelectedOrderTrackingOrDefault<Options>>;
/**
 ...
 * Is a GadgetRecord of the model's type.
 **/
export type UpdateOrderTrackingResult<Options extends UpdateOrderTrackingOptions> = SelectedOrderTrackingOrDefault<Options> extends void ? void : GadgetRecord<SelectedOrderTrackingOrDefault<Options>>;
/**
 ...
 * This is the flattened style of inputs, suitable for general use, and should be preferred.
 **/
export type UpsertOrderTrackingVariables = Omit<UpsertOrderTrackingInput, "on"> & {
    on?: ((Scalars['String'] | null))[];
};
/**
 ...
 *
 **/
export type UpsertOrderTrackingResult<Options extends UpsertOrderTrackingOptions> = SelectedOrderTrackingOrDefault<Options> extends void ? void : GadgetRecord<SelectedOrderTrackingOrDefault<Options>>;
/**
...
export type OrderTrackingManager = {
    ...
    create: {
        ...
        * * const orderTrackingRecord = await api.orderTracking.create({
          ...
          * });
        **/
        <Options extends CreateOrderTrackingOptions>(variables: CreateOrderTrackingVariables, options?: LimitToKnownKeys<Options, CreateOrderTrackingOptions>): Promise<CreateOrderTrackingResult<Options>>;
        /**
         * Executes the create action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
        *
        ...
        * * const orderTrackingRecord = await api.orderTracking.create({
          ...
          * });
        **/
        <Options extends CreateOrderTrackingOptions>(variables: FullyQualifiedCreateOrderTrackingVariables, options?: LimitToKnownKeys<Options, CreateOrderTrackingOptions>): Promise<CreateOrderTrackingResult<Options>>;
        type: 'action';
        ...
        variables: {
            orderTracking: {
                required: false;
                type: 'CreateOrderTrackingInput';
            };
        };
        variablesType: (((FullyQualifiedCreateOrderTrackingVariables | CreateOrderTrackingVariables)) | undefined);
    ...
    bulkCreate: {
        /**
          ...
          */
        <Options extends CreateOrderTrackingOptions>(inputs: (FullyQualifiedCreateOrderTrackingVariables | CreateOrderTrackingVariables)[], options?: LimitToKnownKeys<Options, CreateOrderTrackingOptions>): Promise<CreateOrderTrackingResult<Options>[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkCreateOrderTrackingsInput!]';
            };
        };
    ...
    update: {
        ...
        * * const orderTrackingRecord = await api.orderTracking.update("1", {
          ...
          * });
        **/
        <Options extends UpdateOrderTrackingOptions>(id: string, variables: UpdateOrderTrackingVariables, options?: LimitToKnownKeys<Options, UpdateOrderTrackingOptions>): Promise<UpdateOrderTrackingResult<Options>>;
        /**
         * Executes the update actionon one record specified by `id`.Runs the action and returns a Promise for the updated record.
        *
        * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
        ...
        * * const orderTrackingRecord = await api.orderTracking.update("1", {
          ...
          * });
        **/
        <Options extends UpdateOrderTrackingOptions>(id: string, variables: FullyQualifiedUpdateOrderTrackingVariables, options?: LimitToKnownKeys<Options, UpdateOrderTrackingOptions>): Promise<UpdateOrderTrackingResult<Options>>;
        type: 'action';
    ...
    bulkUpdate: {
        /**
          ...
          */
        <Options extends UpdateOrderTrackingOptions>(inputs: (FullyQualifiedUpdateOrderTrackingVariables | UpdateOrderTrackingVariables & {
            id: string;
        })[], options?: LimitToKnownKeys<Options, UpdateOrderTrackingOptions>): Promise<UpdateOrderTrackingResult<Options>[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkUpdateOrderTrackingsInput!]';
            };
        };
        variablesType: (FullyQualifiedUpdateOrderTrackingVariables | UpdateOrderTrackingVariables & {
            id: string;
        })[];
        paramOnlyVariables: [];
        selectionType: AvailableOrderTrackingSelection;
    ...
    delete: {
        ...
        **/
        <Options extends DeleteOrderTrackingOptions>(id: string, options?: LimitToKnownKeys<Options, DeleteOrderTrackingOptions>): Promise<DeleteOrderTrackingResult<Options>>;
        type: 'action';
    ...
    bulkDelete: {
        /**
          ...
          */
        <Options extends DeleteOrderTrackingOptions>(ids: string[], options?: LimitToKnownKeys<Options, DeleteOrderTrackingOptions>): Promise<DeleteOrderTrackingResult<Options>[]>;
        type: 'action';
    ...
    upsert: {
        ...
        * * const result = await api.orderTracking.upsert({
          ...
          * });
        **/
        <Options extends UpsertOrderTrackingOptions>(variables: UpsertOrderTrackingVariables, options?: LimitToKnownKeys<Options, UpsertOrderTrackingOptions>): Promise<UpsertOrderTrackingResult<Options>>;
        /**
         * Executes the upsert action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
        *
        * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
        ...
        * * const result = await api.orderTracking.upsert({
          ...
          * });
        **/
        <Options extends UpsertOrderTrackingOptions>(variables: FullyQualifiedUpsertOrderTrackingVariables, options?: LimitToKnownKeys<Options, UpsertOrderTrackingOptions>): Promise<UpsertOrderTrackingResult<Options>>;
        type: 'action';
        ...
        variables: {
            ...
            orderTracking: {
                required: false;
                type: 'UpsertOrderTrackingInput';
            };
        };
        variablesType: (((FullyQualifiedUpsertOrderTrackingVariables | UpsertOrderTrackingVariables)) | undefined);
        hasAmbiguousIdentifier: false;
        paramOnlyVariables: ['on'];
        hasReturnType: {
            '... on CreateOrderTrackingResult': {
                hasReturnType: false;
            };
            '... on UpdateOrderTrackingResult': {
                hasReturnType: false;
            };
        };
        acceptsModelInput: true;
    ...
    bulkUpsert: {
        /**
          ...
          */
        <Options extends UpsertOrderTrackingOptions>(inputs: (FullyQualifiedUpsertOrderTrackingVariables | UpsertOrderTrackingVariables)[], options?: LimitToKnownKeys<Options, UpsertOrderTrackingOptions>): Promise<any[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkUpsertOrderTrackingsInput!]';
            };
        };
...
/**
 * A manager for the orderTracking model with all the available operations for reading and writing to it.*/
export declare const OrderTrackingManager: {
